...
# usearch -calc_distmx ClusterX -tabbedout mx_03.txt -maxdist 0.03 -threads "all_available"
usearch_cmd_1 = subprocess.run([usearch_program, "-calc_distmx", code_url, "-tabbedout", mx_code_url, "-maxdist", "0.03", "-threads", str(threads), "-gapopen", "1.0I/0.0E", "-gapext", "1.0I/0.0E"], stdout=subprocess.DEVNULL)
